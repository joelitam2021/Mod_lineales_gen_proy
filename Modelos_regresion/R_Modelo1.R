...
#           "K"=bf$lengua_indigena,"M"=bf$indice)

data<-list("n"=n,"y"=bf$baja,"ne"=bf$n,"S"=bf$nivel_ingresos)
           
#-Defining inits-
#inits<-function(){list(alpha=0,beta1=rep(0,2),beta2=rep(0,3), beta3=rep(0,2),
#                       beta4=rep(0,2),beta5=rep(0,2),yf1=rep(1,n))}

inits<-function(){list(alpha=0,beta1=rep(0,8),yf1=rep(1,n))}

#-Selecting parameters to monitor-
pars<-c("alpha.adj","beta1.adj", "yf1")

#-Running code-
#OpenBUGS
ej.sim<-bugs(data,inits,pars,model.file="R_Modelo1.txt",
